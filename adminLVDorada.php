          ...
          <div class="bootstrap-section">
            ...
            <div class="row">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    $sql = "SELECT idequipo AS 'Número de equipo', nombre AS 'Nombre de equipo', creacion AS 'Creación', goles_totales AS 'Goles totales', partidos_totales AS 'Partidos jugados', partidos_empatados AS 'Partidos empatados', partidos_perdidos AS 'Partidos perdidos', puntos_extras AS 'Puntos extra' FROM TOPOS_Equipos WHERE idLiga = 2";
                    $idLiga = 2;
